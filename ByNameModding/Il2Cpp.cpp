...
#include <jni.h>
#include <string>
#include <android/log.h> // 仍然保留，以防万一
#include <cstdarg>
...
void Il2CppAttach(const char *name) {
    ...
    il2cpp_image_get_class_count = (size_t (*)(const void *))dlsym(handle, "il2cpp_image_get_class_count");
    il2cpp_image_get_class = (const void *(*)(const void *, size_t))dlsym(handle, "il2cpp_image_get_class");
    il2cpp_class_get_name = (const char *(*)(const void *))dlsym(handle, "il2cpp_class_get_name");
    il2cpp_class_get_namespace = (const char *(*)(const void *))dlsym(handle, "il2cpp_class_get_namespace");
